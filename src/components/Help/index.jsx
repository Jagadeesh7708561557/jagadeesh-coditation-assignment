...
function Help() {
  return (
    <>
      ...
      <p className="text-left text-sm sm:text-base py-5 font-regular">
        This a Wordle Game Clone made for Coditation Internship Task for a frontend developer role, by Jagadeesh H Student at VIT Vellore
        </p>
      ...
      <p className="text-left text-sm sm:text-base py-2 opacity-75">
        The letter <b>M</b> is in the word but in the wrong spot.
      </p>
      <div className="flex gap-1">
        <Box value="F" />
        <Box value="L" state="N" />
